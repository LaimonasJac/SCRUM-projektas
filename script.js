...
function modal(item) {
  ...
  console.log(shopItems[index].img1[0]);
...
firebase.auth().onAuthStateChanged((user)=>{
    if(!user){
        ...
        mobProfilePage.innerHTML = '<a class="nav-link" href="auth.html">Login</a>';
        // profilePage.href.innerHTML = 'auth.html';
        ...
        // profilePage.href.innerHTML = 'profile.html';
        profilePage.addEventListener('click', () => {
